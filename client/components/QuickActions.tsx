            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <p style={{ color: "rgb(30,58,138)", fontWeight: 500 }}>
                      Team Chat
                    </p>
                    <p
                      style={{
              ...
              <button
                ...
                style={{
                  appearance: "button",
                  backgroundImage:
                    "linear-gradient(to right, rgb(240, 253, 244), rgb(236, 245, 244))",
              ...
              >
                ...
                >
                  ...
                  >
                    <p style={{ color: "rgb(20,83,45)", fontWeight: 500 }}>
                      Sales Tracker
                    </p>
                    <p
                      style={{
              ...
              >
                ...
                >
                  ...
                  >
                    <p style={{ color: "rgb(124,45,18)", fontWeight: 500 }}>
                      Number Sorter
                    </p>
                    <p
                      style={{
              ...
              <button
                ...
                style={{
                  appearance: "button",
                  backgroundImage:
                    "linear-gradient(to right, rgb(250, 245, 255), rgb(253, 242, 248))",
              ...
              >
                ...
                >
                  ...
                  >
                    <p style={{ color: "rgb(88,28,135)", fontWeight: 500 }}>
                      Admin Panel
                    </p>
                    <p
                      style={{
