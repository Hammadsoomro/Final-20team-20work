...
import { User, adminCreateMember, adminRemoveMember, adminToggleBlock, getUsers } from "@/lib/auth";
            ...
            <CardContent>
              ...
              <div className="mt-4 flex items-center gap-2">
                <Button
                  ...
                  onClick={async () => {
                    await adminToggleBlock(JSON.parse(localStorage.getItem("current_user") || "null"), m.id, !m.blocked);
                    await refresh();
                  }}
                >
                ...
                <Button
                  ...
                  variant="outline"
                  onClick={async () => {
                    await adminRemoveMember(JSON.parse(localStorage.getItem("current_user") || "null"), m.id);
                    await refresh();
                  }}
                >
                  Remove
